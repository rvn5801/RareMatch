...
GEMINI_MODEL = "gemini-2.0-flash"       # Fast, cost-effective for hackathon
...
class MechanismResult(BaseModel):
    ...
    @field_validator("inferred_mechanism")
    @classmethod
    ...
    @field_validator("disrupted_pathway")
    @classmethod
    ...
    @field_validator("pathway_status")
    @classmethod
